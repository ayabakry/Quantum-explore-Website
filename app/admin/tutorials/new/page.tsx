...
export default function NewTutorial() {
  const { addTutorial, tutorials } = useStore()
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newId = (Math.max(...tutorials.map((t) => Number.parseInt(t.id)), 0) + 1).toString()
    ...
    toast({
      ...
      description: "The tutorial has been successfully added.",
    })
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-3xl font-bold tracking-tight">Add New Tutorial</h1>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="rounded-md border border-dashed p-8 text-center">
              <p className="text-muted-foreground">File upload would be implemented here in a production app</p>
            </div>
          </CardContent>
